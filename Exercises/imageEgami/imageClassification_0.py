##########################################
# Classification with Image generaator   #
##########################################
# import the packages
...
#                               verbose=2)
#
# saveModel = os.path.join(mpath,'ic0.h5')
...
loadModel = tf.keras.models.load_model(os.path.join(mpath,'ic0.h5'))
...
from methods import visIntermediate
