...
BCCD_Path = os.path.join(BCCD, 'JPEGImages')
Out_Path = os.path.join(BCCD, 'ImageSets')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", help="Path to output directory",
                        default=Out_Path)
    parser.add_argument("--train_val_rate", help="Path to output directory",
                        default=0.9)
    parser.add_argument("--val_rate", help="Path to output directory",
                        default=0.8)
    ...
    trainval_rate = args["train_val_rate"] #0.9
    train_rate    = args["val_rate"] #0.8
